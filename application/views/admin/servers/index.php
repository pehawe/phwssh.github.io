	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<?php echo form_open(); ?>
				...
				<?php } ?>
				</select> <span class="pull-right"> <a class="btn btn-default btn-sm" href="<?php echo site_url('admin/server/add.html');?>"> <i class="fa fa-server"></i> Add server</a></span>
	...
	<?php }?>
		...
		<div class="panel-footer" style="height:80px;">
		    <small class="text-muted">
		        Show <?php echo count($servers) .'/'. $ini['total_rows']; ?>
		    </small>

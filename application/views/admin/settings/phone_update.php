                          ...
                          <?php echo form_open(uri_string());?>
                           ...
                           <div class="form-group has-feedback">
                            ...
                            <div class="form-group">
								<?php echo form_hidden('id', $phone->id);?>
								<?php echo form_hidden($csrf); ?>
								<?php echo form_submit('submit', 'Simpan', 'class="btn btn-primary"');?>
                                
                                <a href ="<?php echo site_url('admin/setting/phone/'.$phone->id.'/delete.html') ?>" type="button" class="btn btn-danger" id="resetBtn">Delete</a>
                            </div>
                            <?php echo form_close();?>

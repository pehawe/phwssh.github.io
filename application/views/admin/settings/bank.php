						...
						<?php echo $message; ?>
                          ...
                          <?php echo form_open(uri_string());?>
                           ...
                           <div class="form-group has-feedback">
                                <label for="<?php echo $form_label ?>" class ="control-label">No Rekening</label>
                                <br/>
                           ...
                           <div class="form-group has-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <a href ="<?php echo site_url('admin/setting/bank/'.$bank->id.'/delete.html') ?>" type="button" class="btn btn-danger" id="resetBtn">Delete</a>
                            </div>
                            <?php echo form_close();?>

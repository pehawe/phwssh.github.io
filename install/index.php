...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <center><h1>Install</h1></center>
        ...
        <h4>
            ...
            <font color="red">WARNING:!!! Harap menghapus folder install setelah selesai penginstalan.</font>
        </h4>
    ...
    <?php if(is_writable($db_config_path)){?>
        ...
        <fieldset>
          ...
          <h4>
            ...
            <hr/>
            <font color="black">WARNING:!!! Harap ganti email dan password default admin setelah penginstalan.</font>
        </h4>
          <label for="hostname">Hostname</label><input type="text" id="hostname" value="localhost" class="input_text" name="hostname" />
          <label for="username">Username</label><input type="text" id="username" class="input_text" name="username" placeholder="Database User"/>
          <label for="password">Password</label><input type="password" id="password" class="input_text" name="password" placeholder="Password database"/>
